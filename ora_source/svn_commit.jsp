create or replace and compile java source named svn_commit as
...
public class Commit {
    ...
    public static void main_proc() {
        ...
        try {
             ...
             */
            while(err != null) {
            System.out.println(err.getErrorCode().getCode() + " : " + err.getMessage());
    ...
    private static void commitExample() throws SVNException {
        ...
        SVNURL url = SVNURL.parseURIEncoded("http://10.1.71.57:80/svn/test_svn/");
        /*
         * Credentials to use for authentication.
         */
        String userName = "kravchav";
        String userPassword = "Gfhjkm89";
         ...
         */
         BasicAuthenticationManager authManager = new BasicAuthenticationManager(userName, userPassword);
//        ISVNAuthenticationManager authManager = SVNWCUtil.createDefaultAuthenticationManager(userName, userPassword);
    ...
    private static SVNCommitInfo modifyFile(ISVNEditor editor, String dirPath,
        ...
        //SVNCommitInfo info = new SVNCommitInfo((long)1, (String)null, new Date());//
        return  editor.closeEdit();
