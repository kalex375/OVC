create or replace package ora_ver.P_OVC_EXCEPTION is
  /*
   ...
   ******************************
   ...
   Purpose : Оброботка ошибок

  */

  -- Код стандартной ошибки
...
create or replace package body ora_ver.P_OVC_EXCEPTION is
...
begin
  ...
  --По тихому только если записали в лог
